...
func (*certificatesDataSource) Metadata(_ context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_certificates"
}

// Schema defines the schema for the data source.
func (*certificatesDataSource) Schema(_ context.Context, _ datasource.SchemaRequest, resp *datasource.SchemaResponse) {
...
func (d *certificatesDataSource) Read(ctx context.Context, _ datasource.ReadRequest, resp *datasource.ReadResponse) {
	...
	for _, certificate := range certificates {
		// Sort SAN domains
		slices.Sort(certificate.Domains)
		sanDomains := strings.Join(certificate.Domains, ", ")
		...
		certificateState := Certificate{
			...
			Domains:       types.StringValue(sanDomains),
...
func (d *certificatesDataSource) Configure(_ context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
	...
	if !ok {
		resp.Diagnostics.AddError("Unable to configure certificate data", "error while configuring the API client")
